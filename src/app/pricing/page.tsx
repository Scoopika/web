...
export default async function Page() {
  ...
  const faqs: { title: string; description: string }[] = [
    ...
    },
    {
        ...
        description: "In the Pro plan you can deploy a Serverless managed data store with zero setup. after the deployment is successful you can just copy its url and add it to your Scoopika instance, and you're good."
    }
  ];
        ...
        <div className="w-full flex flex-col items-center p-12">
          ...
          <div className="mt-12 w-[80%]">
            <Accordion type="single" collapsible>
              {faqs.map((f, index) => (
                <AccordionItem key={`pricingfaq-${index}`} value={`faqitem-${index}`}>
