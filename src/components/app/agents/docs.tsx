...
export default function AgentDocs({ children, agent }: Props) {
  return (
    <Dialog>
      ...
      <DialogContent className="max-h-screen overflow-auto flex flex-col items-center min-w-[70%]">
        ...
        <Tabs className="w-full" variant="underlined">
          ...
          >
            ...
            <Code
              language="typescript"
              code={serverCode(agent.id, getEngines(agent))}
            />
          </Tab>
          ...
          >
            ...
            <Code
              language="typescript"
              code={apiCode(agent.id, getEngines(agent))}
            />
          </Tab>
