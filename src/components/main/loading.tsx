  ...
  return (
    <div className="w-full p-24 flex items-center justify-center">
      <div className="w-10 h-10 relative">
        <div className="w-10 h-10 absolute top-0 left-0 rounded-full flex items-center justify-center bg-accent/20 z-10">
          <LuCircleDashed className="animate-spin opacity-80" size={18} />
        </div>
